...
describe('SVGGenerator', () => {
  ...
  describe('generateTeamLogo', () => {
    ...
    it('should handle different shapes', async () => {
      const circleSvg = await generator.generateTeamLogo('Test', 'basketball', 'NBA', undefined, {
        shape: 'circle',
      })
      const shieldSvg = await generator.generateTeamLogo('Test', 'basketball', 'NBA', undefined, {
        shape: 'shield',
      })

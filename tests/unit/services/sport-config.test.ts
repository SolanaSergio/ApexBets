...
describe('Sport Configuration Manager', () => {
  ...
  describe('Sport Management', () => {
    ...
    it('should get sport display name', () => {
      expect(SportConfigManager.getSportDisplayName('basketball' as SupportedSport)).toBe('Basketball')
      expect(SportConfigManager.getSportDisplayName('nonexistent' as SupportedSport)).toBe('nonexistent')
    })
  ...
  describe('Async Methods', () => {
    ...
    it('should get default league for sport', async () => {
      const defaultLeague = await SportConfigManager.getDefaultLeague('basketball' as SupportedSport)

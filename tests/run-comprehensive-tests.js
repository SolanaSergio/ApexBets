...
function runUnitTests() {
  ...
  const result = runCommand('pnpm test -- --testPathPattern=unit', 'Unit tests');
  return result;
}
...
function runComprehensiveAPITests() {
  ...
  const result = runCommand('pnpm test -- --testPathPattern=comprehensive', 'Comprehensive API tests');
  return result;
}

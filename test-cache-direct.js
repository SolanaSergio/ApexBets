 ...
 * Tests the cache system directly without requiring a running server
 */
...
async function testCacheSystemDirect() {
  console.log('\n🧪 Testing Cache System Directly...\n')
  ...
  try {
    ...
    const testKey = 'test:direct:cache'
    const testData = {
      message: 'Direct cache test successful',
    ...
    console.log('\n🎉 Direct Cache System Test Complete!')
    console.log('\n📊 Summary:')
    console.log('   - Cache manager imported successfully')
    ...
    console.error('❌ Direct cache system test failed:', error)
    process.exit(1)
  }
}

// Run the test
testCacheSystemDirect()

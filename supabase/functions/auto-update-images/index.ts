...
Deno.serve(async (req: Request) => {
  try {
    ...
    let teamsQuery = supabase
      ...
      .or('logo_url.is.null,last_updated.lt.' + new Date(Date.now() - 90 * 24 * 60 * 60 * 1000).toISOString());
    ...
    let playersQuery = supabase
      ...
      .or('headshot_url.is.null,last_updated.lt.' + new Date(Date.now() - 30 * 24 * 60 * 60 * 1000).toISOString());

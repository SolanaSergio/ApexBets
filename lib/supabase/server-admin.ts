...
/**
 * @deprecated Use mcpDatabaseService instead
...
export function createAdminClient() {
  console.warn('DEPRECATED: createAdminClient() is deprecated. Use mcpDatabaseService instead.')
...
export function createServerClient() {
  console.warn('DEPRECATED: createServerClient() is deprecated. Use mcpDatabaseService instead.')

...
async function testCache() {
  ...
  const result1 = await cachedSupabaseQuery('test_table', 'select', { id: 1 }, async () => {
  ...
  const result2 = await cachedSupabaseQuery('test_table', 'select', { id: 1 }, async () => {
    console.log('Executing query function...')
  ...
  const result3 = await cachedSupabaseQuery('test_table', 'select', { id: 2 }, async () => {
    console.log('Executing query function...')

...
const getSportEndpoints = sport => [
  ...
  {
    path: `/api/database-first/games?sport=${sport}&status=live`,
    method: 'GET',
    name: `Live Games (${sport})`,
  },
  {
    path: `/api/database-first/games?sport=${sport}&status=scheduled`,
    method: 'GET',
    name: `Scheduled Games (${sport})`,
  },
  { path: `/api/database-first/odds?sport=${sport}`, method: 'GET', name: `Odds (${sport})` },
  {
    path: `/api/database-first/standings?sport=${sport}`,
    method: 'GET',
    name: `Standings (${sport})`,
  },
  {
    path: `/api/database-first/predictions?sport=${sport}`,
    method: 'GET',
  ...
  {
    path: `/api/predictions/upcoming?sport=${sport}&limit=5`,
    method: 'GET',
    name: `Upcoming Predictions (${sport})`,
  },
  {
    path: `/api/value-bets?sport=${sport}&min_value=0.1&limit=5`,
    method: 'GET',
    name: `Value Bets (${sport})`,
  },
...
const getEdgeCaseEndpoints = () => [
  ...
  // Date range tests
  {
    path: '/api/database-first/games?date_from=2024-01-01&date_to=2024-12-31',
    method: 'GET',
    name: 'Games (Full Year)',
  },
  {
    path: '/api/database-first/games?date_from=2025-01-01&date_to=2025-01-02',
    method: 'GET',
    name: 'Games (Single Day)',
  },
...
async function testSport(sport) {
  ...
  console.log(
    `  📊 ${sport.toUpperCase()} Results: ${sportResults.passed}/${endpoints.length} (${successRate}%)`
  )
}
...
async function runComprehensiveTests() {
  ...
  // Edge case results
  const edgeTotal =
    results.edgeCaseStats.passed + results.edgeCaseStats.failed + results.edgeCaseStats.errors
